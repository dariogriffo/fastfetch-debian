...
> the .deb from the [Releases](https://github.com/dariogriffo/fastfetch-debian/releases) page
...
1. Download the .deb package for your Debian version available on
   the [Releases](https://github.com/dariogriffo/fastfetch-debian/releases) page.
